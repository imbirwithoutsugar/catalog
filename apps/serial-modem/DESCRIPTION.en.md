...
Supported speeds range from 300 to 115200 bps. Stable operation: 9600 bps by default (optimal for PPP and regular connections), 19200 bps is recommended for file transfer via YMODEM.
