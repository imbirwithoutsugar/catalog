...
У файлі `weather.lua` вставити ключ у поле `api_key`.
У файлі `weather.lua` прописати назву міста у поле `city_name`.

Скрипт оновлює дані кожні 5 хвилин. Також можна оновити натиснувши кнопку `C`.
